      ...
      <div className="mb-8 flex flex-col md:flex-row items-start">
        ...
        <div className="md:w-1/2 md:ml-8">
          ...
          <div className="mb-2"style={{ display: 'flex', gap: '5px' }}>
            <Image src="/images/fishpunch.gif" alt="fishpunch" width={350} height={450} />
            <Image src="/images/fishsplash.gif" alt="fishsplash" width={350} height={450} />
        </div>
        <div className="mb-2"style={{ display: 'flex', gap: '5px' }}>
            <Image src="/images/fishcloud.gif" alt="fishcloud" width={350} height={450} />
            <Image src="/images/fishsakura.gif" alt="fishsakura" width={350} height={450} />
        </div>
