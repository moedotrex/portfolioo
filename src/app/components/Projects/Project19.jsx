    ...
    <div className="container mx-auto px-4 py-24">
      ...
      <div className="mb-8 flex flex-col md:flex-row items-start">
        <div className="md:w-1/2">
          ...
          <div className="mb-4 mt-5"style={{ display: 'flex', gap: '10px' }}>
          <Image src="/images/icecreambg.jpg" alt="icbg" width={600} height={400} />
          </div>
          <p className="text-md text-gray-500 mt-2 mb-4">Game Background</p>
          <div className="mb-4 mt-5"style={{ display: 'flex', gap: '10px' }}>
          <Image src="/images/icecreammenu.PNG" alt="icmenu" width={600} height={400} />
          </div>
        ...
        <div className="mb-4">
        <Image src="/images/icecreamcontrols.gif" alt="iccontrols" width={600} height={400} />
        <p className="text-md text-gray-500 mb-4">Physical Interface</p>
        </div>
        <div className="mb-4">
        <Image src="/images/icecreamstrawberry.png" alt="iccontrols" width={600} height={400} />
        </div>
